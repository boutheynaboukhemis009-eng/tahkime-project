...
/**
 * 6. ⚠️ مسار توجيه الصفحات العام الديناميكي (يجب وضعه في نهاية المسارات دائماً بعد كل مسارات البيانات)
 * [تعديل مسار] تم تغيير مسار البحث التلقائي ليقرأ الملف المطلوب من نفس المجلد الحالي لضمان عمل كافة واجهات صفحاتك
 */
